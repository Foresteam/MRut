...
#define LITTLEENDIAN
    ...
    defined(__THW_INTEL__) || defined(__I86__) || defined(__INTEL__) || defined(__x86_64) || defined(__x86_64__) || defined(__amd64__) || defined(__amd64) ||  \
    defined(_M_X64) || defined(__bfin__) || defined(__BFIN__) || defined(bfin) || defined(BFIN)
...
#elif defined(__arm__) || defined(__arm64) || defined(__thumb__) || defined(__TARGET_ARCH_ARM) || defined(__TARGET_ARCH_THUMB) || defined(__ARM_ARCH) ||       \
